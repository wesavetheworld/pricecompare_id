...
class Migration_Install_unclustered_data_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Unclustered_Data.Crawler.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Unclustered_Data.Crawler.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Unclustered_Data.Crawler.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Unclustered_Data.Crawler.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
